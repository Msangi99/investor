<?php
$pageTitle = 'Settings';
$pageDescription = 'Manage account preferences, security options, contact information and business workspace settings.';
    ...
    <section class="dashboard-hero">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <p>Manage account preferences, security options, contact information and business workspace settings.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <p>Update account details, contact information and workspace preferences.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-lock"></i></div>
                        <h3>Security</h3>
                        <p>Prepare password changes, session control and login security options.</p>
                    </article>
                    <article class="info-card">
