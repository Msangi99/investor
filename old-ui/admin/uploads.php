<?php
$pageTitle = 'Uploads & Documents';
$pageDescription = 'Manage uploaded files, document types, review status and secure file tracking.';
    ...
    <section class="dashboard-hero admin">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <h1>Uploads & Documents</h1>

                <p>Manage uploaded files, document types, review status and secure file tracking.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <p>View all uploaded documents from businesses, investors and stakeholders.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-file-circle-check"></i></div>
                        <h3>Document Status</h3>
                        <p>Approve, reject or request updates for submitted files.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-folder-tree"></i></div>
                        <h3>Document Types</h3>
                        <p>Manage required and optional documents for verification flows.</p>
                    </article>
                </div>
