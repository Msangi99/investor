<?php
$pageTitle = 'UNIDA Invest';
$pageDescription = 'Manage investment opportunities, funding needs, opportunity status, shortlists and pipeline progress.';
$pageName = 'admin-opportunities';
    ...
    <section class="dashboard-hero admin">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <p>Manage investment opportunities, funding needs, opportunity status, shortlists and pipeline progress.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <p>View and manage submitted investment opportunities and scalable projects.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-route"></i></div>
                        <h3>Pipeline Status</h3>
                        <p>Track draft, published, under review, closed and archived opportunities.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-handshake"></i></div>
                        <h3>Investor Matching</h3>
                        <p>Support the right connection between businesses, investors and partners.</p>
                    </article>
                </div>
