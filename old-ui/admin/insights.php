<?php
$pageTitle = 'UNIDA Insights';
$pageDescription = 'Manage updates, reports, analytics, data summaries and decision-support information.';
    ...
    <section class="dashboard-hero admin">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <h1>UNIDA Insights</h1>

                <p>Manage updates, reports, analytics, data summaries and decision-support information.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <h3>Updates</h3>
                        <p>Publish ecosystem updates, notices and sector briefs.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-chart-simple"></i></div>
                        <h3>Analytics</h3>
                        <p>Track users, verification, opportunities, sectors, regions and impact indicators.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-file-export"></i></div>
                        <h3>Reports</h3>
                        <p>Prepare reports for government, investors, stakeholders and internal teams.</p>
                    </article>
                </div>
