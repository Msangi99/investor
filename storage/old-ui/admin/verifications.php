...
$pageDescription = 'Review business profiles, uploaded documents, readiness requests and verification status across UNIDA Verify.';
$pageName = 'admin-verifications';
    ...
    <section class="dashboard-hero admin">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <p>Review business profiles, uploaded documents, readiness requests and verification status across UNIDA Verify.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <p>Track submitted verification requests that need review or action.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-circle-check"></i></div>
                        <h3>Verified Records</h3>
                        <p>View approved profiles, documents and completed verification records.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-comment-dots"></i></div>
                        <h3>Review Comments</h3>
                        <p>Request updates, reject with reasons or add internal reviewer notes.</p>
                    </article>
                </div>
