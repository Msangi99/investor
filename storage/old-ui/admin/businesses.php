...
$pageDescription = 'Manage SMEs, startups, companies, business readiness profiles and investment preparation records.';
    ...
    <section class="dashboard-hero admin">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <p>Manage SMEs, startups, companies, business readiness profiles and investment preparation records.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <p>View business details, sectors, regions, stage and funding needs.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-chart-line"></i></div>
                        <h3>Readiness Scores</h3>
                        <p>Monitor readiness progress and missing preparation steps.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-briefcase"></i></div>
                        <h3>Opportunities</h3>
                        <p>Review businesses that are ready for investment or partner matching.</p>
                    </article>
                </div>
