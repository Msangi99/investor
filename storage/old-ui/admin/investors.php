...
$pageDescription = 'Manage investor accounts, preferred sectors, ticket sizes, pipeline interests and verified access.';
$pageName = 'admin-investors';
    ...
    <section class="dashboard-hero admin">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <p>Manage investor accounts, preferred sectors, ticket sizes, pipeline interests and verified access.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <p>View individual investors, funds, banks and partner investment accounts.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-bookmark"></i></div>
                        <h3>Shortlists</h3>
                        <p>Monitor saved opportunities, interests, meetings and pipeline status.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-shield-halved"></i></div>
                        <h3>Access Control</h3>
                        <p>Approve or suspend investor access based on verification status.</p>
                    </article>
                </div>
