...
$pageDescription = 'Explore published opportunities and scalable projects across sectors, regions, readiness levels and verification status.';
    ...
    <section class="dashboard-hero investor">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <p>Explore published opportunities and scalable projects across sectors, regions, readiness levels and verification status.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <p>Browse investment requests submitted by businesses.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-filter"></i></div>
                        <h3>Smart Filters</h3>
                        <p>Filter by sector, region, stage, amount and readiness.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-shield-halved"></i></div>
                        <h3>Verified Records</h3>
                        <p>Prioritize opportunities with stronger verification and readiness signals.</p>
                    </article>
                </div>

                <?php
                $published = investor_safe_count($pdo, 'investment_opportunities', "status IN ('published','under_review')");
                $verified = investor_safe_count($pdo, 'investment_opportunities', "verification_status = 'verified' AND status IN ('published','under_review')");
                ?>

                <div class="dashboard-stat-grid">
                    <article class="dash-stat"><span class="dash-icon"><i class="fa-solid fa-briefcase"></i></span><div><strong><?= e($published); ?></strong><small>Published opportunities</small></div></article>
                    <article class="dash-stat"><span class="dash-icon green"><i class="fa-solid fa-circle-check"></i></span><div><strong><?= e($verified); ?></strong><small>Verified opportunities</small></div></article>
                    <article class="dash-stat"><span class="dash-icon cyan"><i class="fa-solid fa-layer-group"></i></span><div><strong>Filters</strong><small>Sector, region, stage</small></div></article>
                    <article class="dash-stat"><span class="dash-icon dark"><i class="fa-solid fa-chart-line"></i></span><div><strong>Readiness</strong><small>Review score signals</small></div></article>
                </div>
