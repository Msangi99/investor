...
$pageDescription = 'Manage your investor profile, preferred sectors, regions, ticket range and investment focus.';
    ...
    <section class="dashboard-hero investor">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <p>Manage your investor profile, preferred sectors, regions, ticket range and investment focus.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <h3>Investor Identity</h3>
                        <p>Add investor name, type, organization and profile details.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-bullseye"></i></div>
                        <h3>Investment Focus</h3>
                        <p>Set preferred sectors, regions, stages and opportunity types.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-coins"></i></div>
                        <h3>Ticket Range</h3>
                        <p>Define minimum and maximum ticket size for better matching.</p>
                    </article>
                </div>
                ...
                <article class="dashboard-panel">
                    <div class="panel-head">
                        <div>
                            <h3>Current Investor Profile</h3>
                            <p>Your investor preferences from the database.</p>
                        </div>
                        <span class="status-badge status-verified">
                            <?= e($investorProfile['profile_status'] ?? 'active'); ?>
                        </span>
                    </div>

                    <div class="pipeline-list">
                        <div><span>Investor name</span><strong><?= e($investorProfile['investor_name'] ?? 'Not added'); ?></strong></div>
                        <div><span>Investor type</span><strong><?= e($investorProfile['investor_type'] ?? 'Not added'); ?></strong></div>
                        <div><span>Preferred sectors</span><strong><?= e($investorProfile['preferred_sectors'] ?? 'Not added'); ?></strong></div>
                        <div><span>Preferred regions</span><strong><?= e($investorProfile['preferred_regions'] ?? 'Not added'); ?></strong></div>
                    </div>
                </article>
