...
$pageDescription = 'Review businesses with verified or review-ready profiles, documents, readiness status and investment information.';
    ...
    <section class="dashboard-hero investor">
        <div class="container dashboard-hero-grid">
            <div>
                ...
                <p>Review businesses with verified or review-ready profiles, documents, readiness status and investment information.</p>
            </div>
            ...
            <div class="dashboard-content">
                <div class="cards-grid three-columns">
                    <article class="info-card">
                        ...
                        <p>View business details, sector, location, stage and growth summary.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-file-circle-check"></i></div>
                        <h3>Verification Status</h3>
                        <p>See verified profiles and document review status.</p>
                    </article>
                    <article class="info-card">
                        <div class="icon-box"><i class="fa-solid fa-chart-line"></i></div>
                        <h3>Readiness Score</h3>
                        <p>Compare readiness levels before deeper engagement.</p>
                    </article>
                </div>

                <?php
                $businesses = investor_safe_count($pdo, 'business_profiles');
                $verified = investor_safe_count($pdo, 'business_profiles', "verification_status = 'verified'");
                $review = investor_safe_count($pdo, 'business_profiles', "verification_status IN ('pending','needs_update')");
                ?>

                <div class="dashboard-stat-grid">
                    <article class="dash-stat"><span class="dash-icon"><i class="fa-solid fa-building"></i></span><div><strong><?= e($businesses); ?></strong><small>Total businesses</small></div></article>
                    <article class="dash-stat"><span class="dash-icon green"><i class="fa-solid fa-check"></i></span><div><strong><?= e($verified); ?></strong><small>Verified</small></div></article>
                    <article class="dash-stat"><span class="dash-icon cyan"><i class="fa-solid fa-clock"></i></span><div><strong><?= e($review); ?></strong><small>Under review</small></div></article>
                    <article class="dash-stat"><span class="dash-icon dark"><i class="fa-solid fa-chart-line"></i></span><div><strong>Score</strong><small>Readiness signals</small></div></article>
                </div>
